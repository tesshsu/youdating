  ...
  questions: [
    {
      ...
      answers: [
        ...
        { type: 2, answer: 'Non, je préfère rester discret, je ne vois pas l’utilité d’en informer tout le monde tout le temps.' },
      ]
    },
    {
      question: 'LA PLUPART DU TEMPS, LORSQUE TU ÉCHOUES ?',
      answers: [
        { type: 2, answer: 'Tu l’acceptes assez facilement même si tu es déçu.' },
    ...
    },
    {
      ...
      answers: [
        { type: 1, answer: 'Exigeant avec Toi-même.' },
        { type: 2, answer: 'Compréhensif avec les autres.' },
      ]
    },
  ]
};
...
const SCREEN_2 = {
  ...
  questions: [
    ...
    },
    {
      ...
      answers: [
        { type: 'SPORT', answer: 'Sportif concerné par le physique et le bien-être en général.' },
        { type: 'SPIRIT', answer: 'Spirituel attiré par les religions et l’occulte.' },
        { type: 'INTELLECT', answer: 'Intellectuel intéressé par l’apprentissage et les études en tous genres.' },
        { type: 'COMIQ', answer: 'Comique porté sur le divertissement et la plaisanterie.' }
      ]
    },
  ]
};
  ...
  a: {
    ...
    questions: [
      ...
      },
      {
        ...
        answers: [
          { type: 'UNKNOW', answer: 'Quand tu vis entouré de ta famille.' },
          { type: 'UNKNOW', answer: 'Quand tu vis dans le grand luxe.' },
          { type: 'UNKNOW', answer: 'Quand tu vis d’amour et d’eau fraîche.' },
          { type: 'UNKNOW', answer: 'Quand tu vis comme un globe-trotteur.' },
        ]
      },
    ]
  },
  b: {
    ...
    questions: [
      ...
      },
      {
        question: 'SELON TOI TE CONSIDÈRES-TU HEUREUX ?',
        answers: [
          { type: 'FAMILLY', answer: 'Quand tu vis entouré de ta famille.' },
          { type: 'LUXE', answer: 'Quand tu vis dans le grand luxe.' },
          { type: 'LOVE', answer: 'Quand tu vis d’amour et d’eau fraîche.' },
          { type: 'TRAVEL', answer: 'Quand tu vis comme un globe-trotteur.' },
        ]
      },
    ]
  }
